...
CLASSID_JSON = r"D:\DATA\@car\car_brand_encar\classid_to_folder.json"

IMG_WIDTH, IMG_HEIGHT = 224, 224

def load_model():
    # model_weights_path = 'models_brand_encar/model.58-0.95.hdf5'
    model_weights_path = 'models_brand_encar/model.64-0.94.hdf5'
    # img_width, img_height = 224, 224
    num_channels = 3
    num_classes = 255
